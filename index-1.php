...
<body>
                ...
                <div class="container">
                    <div class="header-inner-box">
                        ...
                        <div class="header-right">
                            ...
                            <a href="contact.php">Get in Touch <i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="hero-area light-bg-2">
        <div class="container">
            <div class="hero-area-content wow fadeInUp animated" data-wow-delay="200ms">
                <h3>Your Trusted Tax Advisor.</h3>
                <h1>Trustworthy Tax <br>Advice</h1>
                <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint sunt in culpa qui officia deserunt <a href="about.php">Discover More</a> </p>
            </div>
            <div class="homepage-slides owl-carousel">
                <div class="single-slide-item">
                    ...
                    <div class="play-btn">
                        <a href="https://www.youtube.com/watch?v=vNiRZWVNK7M" class="video-play-btn mfp-iframe">Play</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-12 wow fadeInLeft animated" data-wow-delay="200ms">
                    <div class="single-service-wrap">
                        <div class="single-service-inner">
                            <h5><a href="service-details.php">Insurance Tax</a></h5>
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority </p>
                            <a href="service-details.php" class="details-link"><i class="las la-arrow-right"></i></a>
                        </div>
                        <div class="single-service-inner">
                            <h5><a href="service-details.php">Audit & Assurancy</a></h5>
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority </p>
                            <a href="service-details.php" class="details-link"><i class="las la-arrow-right"></i></a>
                        </div>
                        <div class="single-service-inner">
                            <h5><a href="service-details.php">Strategic Planning</a></h5>
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority </p>
                            <a href="service-details.php" class="details-link"><i class="las la-arrow-right"></i></a>
                        </div>
                        <div class="single-service-inner">
                            <h5><a href="service-details.php">Financial Planning</a></h5>
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority </p>
                            <a href="service-details.php" class="details-link"><i class="las la-arrow-right"></i></a>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-12 wow fadeInUp animated" data-wow-delay="200ms">
                    <div class="service-content-wrap">
                        ...
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                        <div class="service-bg">
                            <img src="assets/img/service/service-bg.png" alt="">
                            <a href="services.php" class="more-service-btn">Explore More Services</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-12 wow fadeInUp animated" data-wow-delay="200ms">
                    <div class="about-content-wrap">
                        <div class="section-title">
                            <h6>About Company</h6>
                            <h2>Professional Approach
                                and Quality Services</h2>
                        </div>
            ...
            <div class="container">
                <div class="offset-xl-1 col-xl-7 offset-lg-1 col-lg-7 offset-md-1 col-md-7">
                    <div class="section-title">
                        ...
                        <h2 class="text-white">Solve All Your Tax Problems
                            Under One Room</h2>
                    </div>
                ...
                <div class="explore-btn">
                    <a href="service-details.php">Explore Our Service<i class="las la-arrow-right"></i></a>
                </div>
                        ...
                        <div class="testimonial-author-wrap">
                            <div class="single-testimonial-author d-flex align-items-center">
                                <div class="testimonial-thumb">
                                    <img src="assets/img/testimonial/1_thumb.jpg" alt="client-5">
                                </div>
                            ...
                            <div class="single-testimonial-author d-flex align-items-center">
                                <div class="testimonial-thumb">
                                    <img src="assets/img/testimonial/2_thumb.jpg" alt="client-2">
                                </div>
                                <div class="testimonial-content">
                                    <h6>Shawn Beltran</h6>
                                    <p>Entrepreneur</p>
                            ...
                            <div class="single-testimonial-author d-flex align-items-center">
                                <div class="testimonial-thumb">
                                    <img src="assets/img/testimonial/3_thumb.jpg" alt="client-3">
                                </div>
                                <div class="testimonial-content">
                                    <h6>Marko Jhon</h6>
                                    <p>Designation</p>
                            ...
                            <div class="single-testimonial-author d-flex align-items-center">
                                <div class="testimonial-thumb">
                                    <img src="assets/img/testimonial/4_thumb.jpg" alt="client-4">
                                </div>
                                <div class="testimonial-content">
                                    <h6>Nicolas Marko </h6>
                                    <p>Manager</p>
                            ...
                            <div class="single-testimonial-author d-flex align-items-center">
                                <div class="testimonial-thumb">
                                    <img src="assets/img/testimonial/2_thumb.jpg" alt="client-4">
                                </div>
                                <div class="testimonial-content">
                                    <h6>Ryan Gigs</h6>
                                    <p>Tax Officer</p>
                        ...
                        <div class="testimonial-slider-wrap">
                            <div class="testimonial-slide-inner">
                                <div class="testimonal-thumb">
                                    <img src="assets/img/testimonial/1_big.jpg" alt="client-1">
                                </div>
                                <div class="testimonal-slider-content">
                                    <h6>Monica Julian</h6>
                                    <p class="designation">Designation</p>
                                    <p>Nemo enim ipsam voluptatem quia voluptas aut odit aut fugit sed quia consequuntur magni eos voluptatem sequi nesciunts Neque porro quisquam est, qui dolorem dolor</p>
                            ...
                            <div class="testimonial-slide-inner">
                                <div class="testimonal-thumb">
                                    <img src="assets/img/testimonial/2_big.jpg" alt="">
                                </div>
                                <div class="testimonal-slider-content">
                                    <h6>Shawn Beltran</h6>
                            ...
                            <div class="testimonial-slide-inner">
                                <div class="testimonal-thumb">
                                    <img src="assets/img/testimonial/1_big.jpg" alt="">
                                </div>
                                <div class="testimonal-slider-content">
                                    <h6>Marko Jhon</h6>
    ...
    <div class="case-study section-padding white-bg">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-6 wow fadeInLeft animated" data-wow-delay="200ms">
                    <div class="single-case-wrapper" data-background="assets/img/case-study/1.jpg">
                        <div class="case-info-wrap">
                            ...
                            <h6>Date: <span>25 March 2023</span></h6>
                            <a href="case-details.php" class="main-btn">Discover More</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-5 col-md-6 wow fadeInLeft animated" data-wow-delay="300ms">
                    <div class="single-case-wrapper" data-background="assets/img/case-study/2.jpg">
                        <div class="case-info-wrap">
        ...
        <div class="explore-btn">
            <a href="cases.php">View All Projects<i class="las la-arrow-right"></i></a>
        </div>
    </div>
    ...
    <div class="team-section section-padding pb-90">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 text-center">
                    <div class="section-title">
                        <h6>Our Team Members</h6>
                        <h2>Our dedicated tax advisor financial
                            consulting will help you!</h2>
                    </div>
                </div>
            </div>
            <div class="row mt-30">
                <div class="col-xl-4 col-lg-6 col-md-12 col-12 wow fadeInLeft animated" data-wow-delay="200ms">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 col-12 wow fadeInLeft animated" data-wow-delay="400ms">
                    <div class="single-team-wrap">
                        <div class="team-thumb">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 col-12 wow fadeInLeft animated" data-wow-delay="600ms">
                    <div class="single-team-wrap">
                        <div class="team-thumb">
            ...
            <div class="row">
                <div class="col-md-6 col-12 text-center wow fadeInLeft animated" data-wow-delay="200ms">
                    <div class="single-blog-item">
                        ...
                        <h3><a href="blog-details.php">If The White Whale Be Raised It
                ...
                <div class="col-md-6 col-12 text-center wow fadeInLeft animated" data-wow-delay="400ms">
                    <div class="single-blog-item">
                        <div class="blog-meta">
                            <span>Finance</span> . <span>25 March 2023</span>
                        </div>
                        <h3><a href="blog-details.php">Mastercards, just pushes deeper
                                into crypto</a></h3>
                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat </p>
                        <div class="blog-thumb">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="services-list">
                                    <h5>Our Services</h5>
                                    <ul>
                                        <li><i class="las la-check-circle"></i><a href="service-details.php">Insurance Tax</a></li>
                                        <li><i class="las la-check-circle"></i><a href="service-details.php">Audit & Assurancy</a></li>
                                        <li><i class="las la-check-circle"></i><a href="service-details.php">Strategic Planning</a></li>
                                        <li><i class="las la-check-circle"></i><a href="service-details.php">Financial Planning</a></li>
                                        <li><i class="las la-check-circle"></i><a href="service-details.php">Finance Secure</a></li>
                                        <li><i class="las la-check-circle"></i><a href="service-details.php">Porject Management</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-6">
